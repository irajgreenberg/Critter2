...
export class ToneExperiment extends Group {
    ...
    print() {
        ...
        //if (this.partBlue.pos.z > 400) {console.log("Blue Cube Max z = ", this.partBlue.pos.z);};
        //console.log("Red Cube Max = ", maxX);
        ...
        //console.log("--------------------------------------------------------------------------");
        //console.log("-------------------------------------------------------------------------");
        //console.log("Blue Cube Position x = ", this.partBlue.pos.x);
